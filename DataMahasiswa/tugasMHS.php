  ...
  document.getElementById("mySidenav").style.width = "0";
    ...
    <table class="table table-hover " >
		...
		<tr >
            ...
            <td align="center"><a href="kirim_tugas.php?id=<?php echo $d['id']; ?>">
    ...
    <table class="table table-hover " >
		...
		<tr >
            ...
            <td align="center"><a  href="download.php?filename=<?=$a['files']?>"><i class="fa-sharp fa-solid fa-download fa-lg" style="color: #1100ff;"></i></a></td>
            <td align="center">
            <?php
            if($a['nilai']==0){
